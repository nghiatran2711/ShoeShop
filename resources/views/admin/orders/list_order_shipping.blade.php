...
@section('content')
    <div class="header"> 
        <h1 class="page-header">
            List Orders shipping <small>Best form elements.</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Order</a></li>
            <li class="active">List orders shipping</li>
        </ol> 							
	</div>
    <div id="page-inner"> 
        <div class="row">
             ...
             <div class="panel panel-default">
                 <div class="panel-heading">
                     <div class="card-title">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="title">List Orders shipping</div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.order.shipping_success',['id'=>$order->id]) }}" class="btn btn-success">Giao hàng thành công</a><br>
                                        <br>
                                        <a href="{{ route('admin.order.shipping_failure',['id'=>$order->id]) }}" class="btn btn-danger">Giao hàng không thành công</a>
                                    </td>
                                </tr> 
                                @endforeach
